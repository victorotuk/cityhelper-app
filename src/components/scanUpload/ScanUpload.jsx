...
import ScanUsageBar from './ScanUsageBar';
    ...
    <div className="scan-upload">
      {preview && showPreview ? (
        <div className="scan-preview">
          ...
          <button type="button" className="scan-preview-close" onClick={clearPreview}>
            <X size={16} />
          </button>
          {success && (
      ...
      {scanUsage && (
        <ScanUsageBar count={scanUsage.count} limit={scanUsage.limit} />
      )}
