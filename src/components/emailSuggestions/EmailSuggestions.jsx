...
import { FUNCTIONS_URL, PROVIDERS } from './emailSuggestionsConfig';
            ...
            <div className="email-connections-list">
              {PROVIDERS.map(p => (
                <div key={p.id} className="email-connection-row">
                  ...
                  {connections[p.id] ? (
                    <button type="button" className="btn btn-ghost btn-sm" onClick={() => handleDisconnect(p.id)}>
            ...
            {suggestions.map((s, i) => (
              <div key={`${s.email_message_id}-${s.name}-${i}`} className="email-suggestion-row">
                ...
                <div className="email-suggestion-actions">
                  <button type="button" className="btn btn-primary btn-sm" onClick={() => handleAdd(s)}>
                    <Plus size={14} /> Add
                  </button>
                  <button type="button" className="btn btn-ghost btn-sm" onClick={() => handleDismiss(s)}>
                    <X size={14} />
                  </button>
                </div>
              </div>
