          ...
          {(mode === 'signin' || mode === 'signup') && (
            <>
              <div className="auth-oauth-buttons">
                <button type="button" className="btn btn-ghost auth-oauth-btn" onClick={handleGoogleSignIn}>
                ...
                <button type="button" className="btn btn-ghost auth-oauth-btn" onClick={handleAzureSignIn}>
                  <svg width="18" height="18" viewBox="0 0 24 24">
